				...
				<div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">Administrator Report</h3>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
							...
							<br> </br>
								<div class="card card-info" id="report">
				                    <div class="panel-heading">
				                        ...
				                        <h4 class="page-title"> GENERATED ADMINISTRATOR'S REPORT 
				                    ...
				                    <div class="card-body">
									 <table width="100%" class="table table-striped table-bordered table-hover" >
										...
										<hr/>
										<p> <i> Administrator Report Generated at <b style="color:red"><?=$dtime?> </i> </b> </p>
				                        <!-- /.table-responsive -->
				                    </div>
				                    <!-- /.panel-body -->
				                </div>	
						   ...
						   if($number  > 0){
							...
							<br> </br>
								<div class="card card-info" id="report">
				                    <div class="panel-heading">
				                    	<img src="uploadx/headed-paper-transparent.png" style="width: 100%; " />
				                        <h4 class="page-title"> DAILY ADMINISTRATOR'S REPORT 
						   ...
						   if($number  > 0){
							...
							<br> </br>
								<div class="card card-info" id="report">
				                    <div class="panel-heading">
				                    	<img src="uploadx/headed-paper-transparent.png" style="width: 100%; " />
				                        <h4 class="page-title"> WEEKLY ADMINISTRATOR REPORT 
						   ...
						   if($number  > 0){
							...
							<br> </br>
								<div class="card card-info" id="report">
				                    <div class="panel-heading">
				                    	<img src="uploadx/headed-paper-transparent.png" style="width: 100%; " />
				                        <h4 class="page-title"> MONTHLY ADMINISTRATOR REPORT 
