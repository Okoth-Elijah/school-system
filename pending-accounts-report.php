				...
				<div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">Loan Officer's Report</h3>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
					<div class="row">
						...
						<?php
							...
							$sql = $dbh->query("SELECT * FROM users WHERE role ='loan_officer' AND date_registered BETWEEN 
						  	'$start_date' AND '$end_date' order by date_registered DESC");

						  	$number = $dbh->query("SELECT count(*) FROM users WHERE role ='loan_officer' AND date_registered BETWEEN 
							...
							<br> </br>
								<div class="card card-info" id="report">
				                    <div class="panel-heading">
				                        ...
				                        <h4 class="page-title"> GENERATED LOAN OFFICER'S REPORT 
				                    ...
				                    <div class="card-body">
									 <table width="100%" class="table table-striped table-bordered table-hover" >
										...
										<hr/>
										<p> <i> Loan Officer Report Generated at <b style="color:red"><?=$dtime?> </i> </b> </p>
				                        <!-- /.table-responsive -->
				                    </div>
				                    <!-- /.panel-body -->
				                </div>	
						  ...
						  '$start_date' AND '$end_date' order by date_registered DESC")->fetchColumn();
						   if($number  > 0){
							...
							<br> </br>
								<div class="card card-info" id="report">
				                    <div class="panel-heading">
				                        <h4 class="page-title"> DAILY LOAN OFFICER'S REPORT 
						  ...
						  '$start_date' AND '$end_date' order by date_registered DESC")->fetchColumn();
						   if($number  > 0){
							...
							<br> </br>
								<div class="card card-info" id="report">
				                    <div class="panel-heading">
				                        <h4 class="page-title"> WEEKLY SALES REPORT 
										(TOTAL SALES: <strong style="color:red"> UGX&nbsp;<?=number_format($cost)?> </strong>)
										</h4>
				                    </div>
				                    <!-- /.panel-heading -->
				                    <div class="card-body">
						  ...
						  '$start_date' AND '$end_date' order by date_registered DESC")->fetchColumn();
						   if($number  > 0){
							...
							<br> </br>
								<div class="card card-info" id="report">
				                    <div class="panel-heading">
				                        <h4 class="page-title"> MONTHLY SALES REPORT 
										(TOTAL SALES: <strong style="color:red"> UGX&nbsp;<?=number_format($cost)?> </strong>)
										</h4>
				                    </div>
				                    <!-- /.panel-heading -->
